        ...
        <section className="panel loop-detail-panel">
          {selected ? <>
            ...
            <div className="loop-detail-body">
              ...
              <Detail label="额外允许路径"><strong>{(selected.allowedDirectories ?? []).length ? (selected.allowedDirectories ?? []).join("、") : "未配置"}</strong><small>项目目录始终允许；OpenCode 按目录申请权限时需添加对应目录</small></Detail>
